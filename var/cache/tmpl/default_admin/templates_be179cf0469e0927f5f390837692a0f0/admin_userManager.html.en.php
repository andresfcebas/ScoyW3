<div id="manager-actions">
    ...
    <?php if ($t->conf['cookie']['rememberMeEnabled'])  {?><a class="action delete" href="<?php if ($this->options['strict'] || (isset($t) && method_exists($t, 'makeUrl'))) echo htmlspecialchars($t->makeUrl("removeExpiredCookies","user","user"));?>"><?php if ($this->options['strict'] || (isset($t) && method_exists($t, 'translate'))) echo htmlspecialchars($t->translate("Remove expired cookies"));?></a><?php }?>
</div>
<div id="content">
